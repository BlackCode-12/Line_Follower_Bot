...
#define blackThreshold 1020
#define whiteThreshold 800
...
int const m1a1=3;  //motor 1 +ve pin  //left motor
int const m1b1=5;  //motor 1 -ve pin
int const m2a2=6;  //motor 2 +ve pin  //right motor
int const m2b2=9;  //motor 2 +ve pin
...
void turnLeft() {
  ...
  digitalWrite(m1b1,HIGH);//left motor wheel backward
  digitalWrite(m2a2,HIGH);//right motor wheel forward
...
void turnRight() {
  /*qik.setM0Speed(M0Speed);
  qik.setM1Speed(-M1Speed);*/
  digitalWrite(m1a1,HIGH);//left motor wheel forward
  digitalWrite(m1b1,LOW);
  digitalWrite(m2a2,LOW);
  digitalWrite(m2b2,HIGH);//right motor wheel backward
  //if the turn is started on a black line, it needs to get off the line first
  while (centeredOnLine());
  delay(200);
  while (!centeredOnLine());
